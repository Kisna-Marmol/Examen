...
public class ApiService {
    ...
    public static void guardarDatos(String nombreProducto, String codigoBarras, Double precioCosto, int porcentajeGanacia, Double precioVenta, boolean activo, ApiCallback callback)
    {
        JSONObject json = new JSONObject();
        try {
            json.put("nombre_producto", nombreProducto);
            json.put("codigo_barras", codigoBarras);
            json.put("precio_costo", precioCosto);
            json.put("porcentaje_ganancia", porcentajeGanacia);
            json.put("precio_Venta", precioVenta);
